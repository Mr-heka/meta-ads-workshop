---
name: ad-creative
description: "Generates and iterates paid ad creative at scale - headlines, descriptions and primary text for Google, Meta, LinkedIn, TikTok and X. Use when the user wants ad copy variations, RSA headlines, a bulk ad batch, or new ads from performance data."
metadata:
  version: 1.2.0
---
...
```bash
node scripts/check-char-limits.mjs your-copy.csv   # run from this skill's folder
```
...
### 3. Quality filter
- Run `node scripts/check-char-limits.mjs <batch>.csv` to catch every over-limit line - don't rely on eyeballed counts
...
- **Meta (Facebook / Instagram):** if the `meta-ads-connect` skill is set up, pull ad and campaign performance through it directly. If it isn't, offer to set it up, or have the user export the report from Meta Ads Manager.
...
<!-- Provenance marker: sk-14rignw --><!-- Provenance signature: ⁠​‌​‌​​‌‌​‌​​​‌​‌​‌​​‌‌​​​‌​‌​​‌​​​‌‌​​​‌⁠ -->
